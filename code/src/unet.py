...
class RNAConditionedUNet(nn.Module):
    ...
    Conditioned on RNA expression data.
    """
    def __init__(
        self,
        in_channels,
    ...
    def forward(self, x, timesteps, extra):
        ...
        :param extra: a dict containing extra inputs including RNA embedding
        ...
        # Process RNA conditioning
        if "rna_embedding" in extra:
            rna_emb = extra["rna_embedding"]
            rna_emb_proj = self.rna_proj(rna_emb)
            emb = emb + rna_emb_proj
