...
sbatch -J g2i_b1 --export=$COMMON,BATCH=1 slurm/alpha_batch.slurm
sbatch -J g2i_b2 --export=$COMMON,BATCH=2 slurm/alpha_batch.slurm
sbatch -J g2i_b3 --export=$COMMON,BATCH=3 slurm/alpha_batch.slurm
sbatch -J g2i_b4 --export=$COMMON,BATCH=4 slurm/alpha_batch.slurm
sbatch -J g2i_b5 --export=$COMMON,BATCH=5 slurm/alpha_batch.slurm
sbatch -J g2i_b6 --export=$COMMON,BATCH=6 slurm/alpha_batch.slurm
sbatch -J g2i_b7 --export=$COMMON,BATCH=7 slurm/alpha_batch.slurm
